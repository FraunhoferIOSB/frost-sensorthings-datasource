...
System.register([], function (_export, _context) {
    ...
    var _typeof, globalEval, supportsNodeVM, allowedResultTypes, hasOwnProp, moveToAnotherArray, vm, NewError;
    ...
    */
    ...
    return {
        ...
        execute: function () {
            ...
            globalEval = eval;
            supportsNodeVM = typeof module !== 'undefined' && Boolean(module.exports) && !(typeof navigator !== 'undefined' && navigator.product === 'ReactNative');
            allowedResultTypes = ['value', 'path', 'pointer', 'parent', 'parentProperty', 'all'];
            hasOwnProp = Object.prototype.hasOwnProperty;

            moveToAnotherArray = function moveToAnotherArray(source, target, conditionCb) {
            ...
            NewError = function (_Error) {
                ...
                function NewError(value) {
                    ...
                    var _this = _possibleConstructorReturn(this, (NewError.__proto__ || Object.getPrototypeOf(NewError)).call(this, 'JSONPath should not be called with "new" (it prevents return of (unwrapped) scalar values)'));
            ...
            JSONPath.prototype.evaluate = function (expr, json, callback, otherTypeCallback) {
                ...
                json = json || this.json;
                expr = expr || this.path;
                if (expr && (typeof expr === 'undefined' ? 'undefined' : _typeof(expr)) === 'object') {
                    if (!expr.path) {
            ...
            JSONPath.prototype._trace = function (expr, val, path, parent, parentPropName, callback, literalPriority) {
                ...
                if ((typeof loc !== 'string' || literalPriority) && val && hasOwnProp.call(val, loc)) {
                    ...
                    switch (valueType) {
                        ...
                        case 'scalar':
                            if (!val || !['object', 'function'].includes(typeof val === 'undefined' ? 'undefined' : _typeof(val))) {
                                addType = true;
                            }
                            break;
                        case 'boolean':case 'string':case 'undefined':case 'function':
                            if ((typeof val === 'undefined' ? 'undefined' : _typeof(val)) === valueType) {
                                // eslint-disable-line valid-typeof
                                addType = true;
                            }
                            break;
                        case 'number':
                            if ((typeof val === 'undefined' ? 'undefined' : _typeof(val)) === valueType && isFinite(val)) {
                                // eslint-disable-line valid-typeof
                                addType = true;
                            }
                            break;
                        case 'nonFinite':
                            ...
                            break;
                        case 'object':
                            if (val && (typeof val === 'undefined' ? 'undefined' : _typeof(val)) === valueType) {
                                // eslint-disable-line valid-typeof
                                addType = true;
                            }
                            break;
